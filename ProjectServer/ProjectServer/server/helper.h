...
public:
	...
	static std::string getUsersString(std::set<std::string> usernames);
	static std::string buildFileName(std::string secondUsername, std::string firstUsername);
	static std::string buildMagshMessageByFormat(std::string author, std::string newMessage);
	static void insertMessageToFiles(Server& myServer);
	static std::string getFileContent(std::string firstUsername, std::string secondUsername);
private:
